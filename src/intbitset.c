 ...
 */
        ...
        /* "/usr/portage/build/cds-invenio/src/intbitset.pyx":293
 *             else:
 *                 for elem in rhs:
 *                     intBitSetDelElem(self.bitset, elem)             # <<<<<<<<<<<<<< 
 *         return self
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/usr/portage/build/cds-invenio/src/intbitset.pyx":425
 *         This has no effect if the element is already present."""
 *         if self.sanity_checks:
 *             if elem < 0:             # <<<<<<<<<<<<<< 
 *                 raise ValueError, "Negative numbers, not allowed"
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/usr/portage/build/cds-invenio/src/intbitset.pyx":448
 *         If the element is not a member, do nothing."""
 *         if self.sanity_checks:
 *             if elem < 0:             # <<<<<<<<<<<<<< 
 *                 raise ValueError, "Negative numbers, not allowed"
...
static PyObject *__pyx_pf_9intbitset_9intbitset_intersection(PyObject *__pyx_v_self, PyObject *__pyx_v_rhs) {
  ...
  /* "/usr/portage/build/cds-invenio/src/intbitset.pyx":458
 *         (i.e. all elements that are in both intbitsets.)
 *         """
...
static PyObject *__pyx_pf_9intbitset_9intbitset_union(PyObject *__pyx_v_self, PyObject *__pyx_v_rhs) {
  ...
  /* "/usr/portage/build/cds-invenio/src/intbitset.pyx":468
 *         (i.e. all elements that are in either intbitsets.)
 *         """
