...
/* "/mnt/disk1/build/cds-invenio/src/intbitset.pyx":745
 *     cdef IntBitSet *bitset
 * 
...
/* "/mnt/disk1/build/cds-invenio/src/intbitset.pyx":749
 *         self.bitset = bitset.bitset
 * 
 *     def __next__(self):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/mnt/disk1/build/cds-invenio/src/intbitset.pyx":752
 *         self.last = intBitSetGetNext((<intbitset_iterator>self).bitset, self.last)
 *         if self.last < 0:
 *             self.last = -2             # <<<<<<<<<<<<<<
 *             raise StopIteration()
...
/* "/mnt/disk1/build/cds-invenio/src/intbitset.pyx":756
 *         return self.last
 * 
 *     def __iter__(self):             # <<<<<<<<<<<<<<
 *         return self
